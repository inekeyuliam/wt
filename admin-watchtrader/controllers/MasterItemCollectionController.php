...
use app\models\MasterCollectionItemSearch;
use yii\data\Pagination;
use yii\web\UploadedFile;
class MasterItemCollectionController extends Controller
{
    /**
     * {@inheritdoc}
     */
    ...
    public function actionIndex()
    {
        ...
        $searchModel = new MasterCollectionItemSearch();
    ...
    {
        $model = new MasterCollectionItem();
    ...
    {
        $model = MasterCollectionItem::findOne($id);
