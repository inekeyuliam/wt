...
<body>
		...
		<main role="main" class="content">
			...
			<div class="container-banner-faq d-flex flex-column flex-md-row justify-content-between container-fluid">
					<div class="faq-img d-flex">
						<img src="assets/img/faq.png" style="width:100%">
					</div>
					<div class="faq-detail-container justify-content-center d-flex flex-column text-center">
						<div class="faq-desc d-flex justify-content-center flex-column">
							<h3 >sell your luxury<br><span>with us !</span></h3>
							<p class="detail">
							Time to upgrade? <br><br>
							Sell your preowned luxury watch today with us! Experience the luxury of seamless transactions and trusted evaluations.
							</p>
							<div class="d-flex btn-sell">
								<a href="https://wa.me/6281234560784" target="_blank"  class="btn-sell-now">Sell now</a>
							</div>
						</div>
					</div>
			</div>
			
			<div class="container-faq-1 d-flex flex-column-reverse flex-md-row align-items-center text-center">
				<div class="d-flex flex-column">
					<h2 class="featurette-heading">How to sell With Watches trader</h2>
					<p class="lead">Maximize your timepiece and sell your preowned luxury watch with trust! Guarantee authenticity, provide a streamlined process, and ensure an easy experience that makes your transition effortless!</p>
				</div>
			</div>
			<div class="container container-sell">
				<div class="d-flex  flex-column flex-md-row ">
					<div class="col-md-3 box-review d-flex justify-content-center flex-row">
						<div class="how-desc">
							<div class="how-desc-1">
								<img src="assets/img/how-1.png" style="height:20px;width:20px"/>
							</div>
							<div class="how-desc-2">
								<p class="title">1. Fill in the form</p>
							</div>
							<div class="how-detail">
								<p class="detail">Fill out our online form with the information of the luxury item you wish to sell.</p>
							</div>
						</div>
					</div>
					<div class="col-md-3 box-review d-flex justify-content-center flex-row">
						<div class="how-desc">
							<div class="how-desc-1">
								<img src="assets/img/how-2.png" style="height:20px;width:20px"/>
							</div>
							<div class="how-desc-2">
								<p class="title">2. Watch inspection time</p>
							</div>
							<div class="how-detail">
								<p class="detail">Visit our boutique store to submit your luxury item. Our team will assess its condition and verify its authenticity.</p>
							</div>
						</div>
					</div>
					<div class="col-md-3 box-review d-flex justify-content-center flex-row">
						<div class="how-desc">
							<div class="how-desc-1">
								<img src="assets/img/how-3.png" style="height:20px;width:20px"/>
							</div>
							<div class="how-desc-2">
								<p class="title">3. Leave it in our care</p>
							</div>
							<div class="how-detail">
								<p class="detail">Your item will be listed for sale and presented to our worldwide clientele network.</p>
							</div>
						</div>
					</div>
					<div class="col-md-3 box-review d-flex justify-content-center flex-row">
						<div class="how-desc">
							<div class="how-desc-1">
								<img src="assets/img/how-4.png" style="height:20px;width:20px"/>
							</div>
							<div class="how-desc-2">
								<p class="title">4. Get paid!</p>
							</div>
							<div class="how-detail">
								<p class="detail">After the sale is finalized, we'll process the payment and transfer it within 3 business days.</p>
							</div>
						</div>
					</div>
				</div>
			...
			<div class="d-flex align-items-center justify-content-center explore-collection">
				<h3 >Watches on hidh <span>demand</span></h3>
			</div>
			<div class="container high-demand">
				<div class="row">
					<div class="desc d-flex align-items-center col-md-2">
						<p>Explore our unique range of preowned luxury watches, a curated assortment of refined timepieces designed to suit your taste. Delve into our collection today!</p>
					</div>
					<div class="brand-items col-md-10">
				...
				<div class="row-view d-flex align-items-center justify-content-center">
					<a href="https://wa.me/6281234560784" target="_blank"  class="view-all-button">Sell now</a>
				</div>
			</div>
			...
			<div class="container container-faq">
				<div class="d-flex justify-content-between title">
					...
					<div class="d-flex justify-content-between right">
						<a href="#">view all </a>
						<a href="#"><svg xmlns="http://www.w3.org/2000/svg" width="8" height="10" viewBox="0 0 8 10" fill="none">
						<path d="M2.22949 0.559937L1.60449 1.10681L5.1071 5.00004L1.60449 8.89327L2.22949 9.44014L5.97949 5.27348L6.22689 5.00004L5.97949 4.7266L2.22949 0.559937Z" fill="#100C08" stroke="#100C08" stroke-width="1.25"/>
						</svg></a>
					</div>
				</div>
				<div id="accordion">
					<div class="card">
						<div class="card-header d-flex justify-content-between align-items-center" id="headingOne">
							...
							<h5 class="mb-0">
								...
								CAN I SELL MY LUXURY ITEM THROUGH CONSIGNMENT SERVICE?
								</button>
							</h5>
							<svg xmlns="http://www.w3.org/2000/svg" width="10" height="8" viewBox="0 0 10 8" fill="none">
							<path d="M10 2.31396L9.45312 1.68896L5.5599 5.19157L1.66667 1.68896L1.11979 2.31396L5.28646 6.06396L5.5599 6.31136L5.83333 6.06396L10 2.31396Z" fill="#100C08" stroke="#100C08" stroke-width="1.25"/>
							</svg>
						</div>
					...
					<div class="card">
						...
						<h5 class="mb-0">
							<button class="btn btn-faq collapsed" data-toggle="collapse" data-target="#collapseThree" aria-expanded="false" aria-controls="collapseThree">
...
<script>
  $(document).ready(function(){
    ...
    $(".owl-next").on("click", function(){
        ...
        $(".owl-prev").css("display", "block"); // Show the previous button
    });
	...
	$('.card-header button').click(function () {
      // Toggle the 'fa-chevron-up' and 'fa-chevron-down' classes on the clicked button's icon
      $(this).find('.toggle-icon').toggleClass('fa-chevron-up fa-chevron-down');
    });
	var carouselContainer = $('.watch-carousel');
	var url = 'get_diskon_soldout.php';
	$.post( url, { })
      .done(function( data ) {
        var html = "";
