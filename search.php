	...
	<main role="main" class="content">
			...
			<div class="container-fluid fluid-filter">
				...
				<div class="container-item-product d-flex flex-wrap container">
					...
					<?php 
						if (isset($_GET['key'])) {
							$searchQuery = $_GET['key'];
											
								$sql = "SELECT mi.id AS id_item, tag ,kode_barang, label_harga AS price ,mc.nama AS category, mi.nama AS nama, mj.id AS id_jenis, mj.nama AS brand 
								...
								WHERE mi.nama LIKE '%$searchQuery%'
								OR mj.nama LIKE '%$searchQuery%'";
