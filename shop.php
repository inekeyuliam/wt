			...
			<div class="container-fluid fluid-filter">
				...
				<div class="container-item-product d-flex flex-wrap container">
					<div class="item d-flex flex-column">
								<img class="item-product" src="assets/img/1.png" alt="Image 1">
					...
					<div class="item d-flex flex-column">
								<img class="item-product" src="assets/img/2.png" alt="Image 1">
								<div class="owl-item-text">
									<h3>Rolex</h3>
									<p>Submariner</p>
									<div class="desc">41mm Steel and Yellow Gold Ceramic Bezel Black Dial</div>
					...
					<div class="item d-flex flex-column">
								<img class="item-product" src="assets/img/3.png" alt="Image 1">
								<div class="owl-item-text">
									<h3>Rolex</h3>
									<p>Submariner</p>
									<div class="desc">41mm Steel and Yellow Gold Ceramic Bezel Black Dial</div>
