...
<body>
		...
		<main role="main" class="content">
				...
				<div class="container-inside-about flex-column flex-md-row  d-flex ">
					<div class="container-about">
						<div class="about-desc-1">
							...
							<p class="detail">Watches Trader</p>
						</div>
						<div class="about-detail">
							<p>
								We are the leading market for preowned luxury watches in Indonesia. Explore our carefully curated assortment of 100% authentic preowned luxury watches that redefine elegance. <br><br>
								With a history of satisfied buyers, we guarantee a seamless shopping experience. Embark on your horological journey now and select your symbol of luxury from our  curated timepiece collection!</p>
						</div>
					</div>
					<div class="review-img">
						<img src="assets/img/business.png" style="width:100%">
					</div>
				</div>
			</div>
			<div class="d-flex align-items-center justify-content-center experts">
			...
			<div class="container-why-title container-fluid">
				<div class="d-flex align-items-center justify-content-center experts">
					<h3 >Meet our <span>experts</span></h3>
				</div>
			</div>
			<div class="container-why container-fluid">
				<div class="container-inside">
					<div class="row">
			...
			<div class="container d-flex flex-column container-contact">	
				...
				<br>Tell us what you want to see and when you want to come in. so we can be ready for you.
				</p>
			</div>
			<div class="container-map d-flex  flex-column flex-md-row justify-content-center container-fluid">
				<div class="container-inside-map flex-column flex-md-row  d-flex ">
					<div class="map-img">
						<iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3957.560666821465!2d112.67424369999999!3d-7.2907212999999995!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2dd7fd9837199ca5%3A0x8c8393b71a3c843e!2sPakuwon%20Trade%20Center!5e0!3m2!1sen!2sid!4v1694236546528!5m2!1sen!2sid" width="100%" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
					</div>
					<div class="d-flex flex-column container-detail-map">
						<div class="map-desc d-flex flex-column">
							<h3 >find <span>us</span></h3>
							<p class="detail">Watches Trader store</p>
						</div>
						<div class="map-detail d-flex flex-column">
							<p class="address">Pakuwon Trade Center<br><br>
							Level UG Unit F3/06-08<br><br>
