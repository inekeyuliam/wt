				...
				<?php
					if(isset($_GET['id'])){
						...
						while($row = mysqli_fetch_array($sql_brand)){
							...
							$str_image = 'select * from master_item_image where id = '. $row["id"] .' limit 1';
							$sql_image = mysqli_query($conn,$str_image);
							$row_image = mysqli_fetch_array($sql_image);
							echo '   
							<div class="item d-flex flex-column">
								<a href="detail.php?id='.$row['id'].'"><img class="item-product" src="assets/img/1.png" alt="Image 1"></a>
						...
						FROM master_item mi
						LEFT JOIN master_jenis mj ON mj.id = mi.id_master_jenis where mj.id = '. $_GET['brand'] ;
						$sql_brand = mysqli_query($conn,$str_brand);
						while($row = mysqli_fetch_array($sql_brand)){
							$qty = $row['qty'] == 0 ? 'Sold' :'';
							...
							echo '   
							<div class="item d-flex flex-column">
								<a href="detail.php?id='.$row['id_item'].'"><img class="item-product" src="assets/img/1.png" alt="Image 1">
								<div class="owl-item-text">
